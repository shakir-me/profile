          ...
          <div class="col-md-12">
            ...
            <div class="card">
              <div class="card-header">
                ...
                <div class="card-body">
       <form action="{{route('store.project')}}" method="post" role="form" enctype="multipart/form-data">
        @csrf
                  <div class="form-row">
                    ...
                    <div class="form-group col-md-6">
                      ...
                      <input type="text" name="count" placeholder="Project Count" class="form-control">
                    </div>
