      ...
      <div class="container-fluid">
          ...
          <div class="col-md-12">
            ...
            <div class="card">
              <div class="card-header">
                <h3>Edit Service  
                   <a class="btn btn-success float-right btn-sm" href="{{route('all.service')}}"><i class="fa fa-plus-circle"></i>All Service</a>
                </h3>
              </div>
       ...
       <form action="{{route('update.service',$edit_data->id)}}" method="post" role="form" enctype="multipart/form-data">
        @csrf
                ...
                <img id="logo" src="{{asset('admin/service/'.$edit_data->image) }}" width="50" height="50;" />
                      </div>
