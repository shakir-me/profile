          ...
          <div class="col-md-12">
            ...
            <div class="card">
              <div class="card-header">
                <h3>All Work  
                   <a class="btn btn-success float-right btn-sm" href="{{route('add.work')}}"><i class="fa fa-plus-circle"></i>Add Work</a>
                </h3>
              </div>
                ...
                <div class="card-body">
                  ...
                  <td>
                  <img id="logo" src="{{asset('admin/work/'.$row->image) }}" width="50" height="50;" alt="image" />
                </td>
